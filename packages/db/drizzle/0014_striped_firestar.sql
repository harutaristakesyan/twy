...
CREATE TABLE "office_expense_payment_order_files" (
	...
	CONSTRAINT "oepo_files_pk" PRIMARY KEY("office_expense_payment_order_id","file_id")
);
--> statement-breakpoint
...
ALTER TABLE "office_expense_payment_order_files" ADD CONSTRAINT "oepo_files_order_fk" FOREIGN KEY ("office_expense_payment_order_id") REFERENCES "public"."office_expense_payment_order"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "office_expense_payment_order_files" ADD CONSTRAINT "oepo_files_file_fk" FOREIGN KEY ("file_id") REFERENCES "public"."file"("id") ON DELETE restrict ON UPDATE no action;