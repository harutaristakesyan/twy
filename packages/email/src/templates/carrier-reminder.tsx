...
export default function CarrierReminderEmail({
  invoiceId,
  loadId,
  dueAt,
  amount,
  ...
  return (
    <Html lang="en">
      <Head />
      <Preview>Carrier payment due soon — Invoice {invoiceId}</Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          <Section style={styles.card}>
            <Heading style={styles.heading}>Carrier Payment Due Soon</Heading>
            ...
            <Text style={styles.value}>{dueAt}</Text>
            <Hr style={styles.divider} />
