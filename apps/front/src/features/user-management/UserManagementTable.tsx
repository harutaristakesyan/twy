...
import { EditOutlined, DeleteOutlined, UserAddOutlined, SearchOutlined, FilterOutlined, ReloadOutlined, UserOutlined } from '@ant-design/icons'
...
const UserManagementTable: React.FC = () => {
  ...
  const columns: ColumnsType<User> = [
    ...
    },
    {
      ...
      dataIndex: 'role',
      key: 'role',
      render: (role: UserRole) => <Tag color={getRoleColor(role)}>{USER_ROLE_LABELS[role]}</Tag>,
      sorter: true,
    ...
    },
    {
      ...
      dataIndex: 'isActive',
      key: 'isActive',
      render: (isActive: boolean) => <Badge status={isActive ? 'success' : 'error'} text={isActive ? 'Active' : 'Inactive'} />,
      sorter: true,
    ...
    },
    {
      ...
      render: (_, record) => {
        ...
        const tooltipMessage = isCurrentUser ? 'You cannot edit or delete your own account' : ''
  ...
  return (
    <div>
      ...
      <UserCreateModal visible={isCreateModalVisible} onCancel={() => setIsCreateModalVisible(false)} onSuccess={handleCreateSuccess} />
    </div>
  )
}
