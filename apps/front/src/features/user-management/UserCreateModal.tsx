...
import { Modal, Form, Input, Select, Switch, Button, Space, message, Alert, Spin } from 'antd'
...
const UserCreateModal: React.FC<UserCreateModalProps> = ({ visible, onCancel, onSuccess }) => {
  ...
  return (
    <Modal title="Create New User" open={visible} onCancel={handleCancel} footer={null} width={600}>
      <Alert
