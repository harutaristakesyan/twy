...
export class AppDeployStack extends Stack {
  constructor(scope: Construct, id: string, props: AppDeployStackProps) {
    ...
    const bucketName = StringParameter.valueForStringParameter(
      this,
      `/${props.cloudFormantName}/site/bucketName`,
    );

    const cloudFrontId = StringParameter.valueForStringParameter(
      this,
      `/${props.cloudFormantName}/site/distributionId`,
    );

    const cloudFrontDomain = StringParameter.valueForStringParameter(
      this,
      `/${props.cloudFormantName}/site/distributionDomain`,
    );
