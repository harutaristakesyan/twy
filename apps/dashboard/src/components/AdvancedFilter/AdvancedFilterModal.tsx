...
export function AdvancedFilterModal({
  ...
  useEffect(() => {
    ...
    // Convert stored strings back to dayjs for dateRange fields
  ...
  }, [quickValues, quickFields, matchMode, rules, onApply]);
  ...
  return (
    <Modal
      ...
      footer={
        <Flex justify="space-between" align="center">
          <Button type="text" danger onClick={handleResetAll}>
            Reset all
          </Button>
          <Space>
    ...
    >
      <Flex vertical gap="middle" style={{ width: "100%", marginTop: 8 }}>
        {/* Match mode */}
