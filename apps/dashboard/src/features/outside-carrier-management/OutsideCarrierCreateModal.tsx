...
import { CarrierStatus, type OutsideCarrierFormData } from "@/entities/outside-carrier/types";
...
const OutsideCarrierCreateModal: React.FC<OutsideCarrierCreateModalProps> = ({
  visible,
  onCancel,
  onSuccess,
}) => {
    ...
    >
      ...
      <Form form={form} layout="vertical" onFinish={handleSubmit} id="outsideCarrierCreateForm">
        ...
        <Form.Item name="equipmentType" label="Equipment Type">
          <Input
            placeholder="Enter equipment type (e.g., Flatbed, Dry Van, Refrigerated)"
